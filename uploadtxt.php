...
if(isset($_POST["submit1"]) && !empty($_FILES["file"]["name"])){
    ...
    $allowTypes = array('txt','pdf','doc','docx','zip','exe','xls','ppt');
    if(in_array($fileType, $allowTypes)){
        ...
        $statusMsg = 'Sorry, only TXT, PDF, DOC, DOCX, ZIP, EXE, XLS, & PPT files are allowed to upload.';
    }
} else {
